...
//
// This file is a byte-identical mirror of `src/lib/reportConcernFormatter.ts`
// between the MIRROR REGION markers. It exists so the Deno edge function
// `public-report-download-pdf` can consume the exact same formatter used by
// the live report page — guaranteeing PDF/live parity.
//
// If you need to change the formatter, edit `src/lib/reportConcernFormatter.ts`
// and copy the MIRROR REGION contents into this file in the SAME commit.
// The parity test `src/lib/reportConcernFormatter.parity.test.ts` will fail
// the build if the two files drift.
// =============================================================================
